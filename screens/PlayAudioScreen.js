    ...
    <SafeAreaView>
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.textReader}>
          <Text style={styles.textStyle}>{sampleText}</Text>
        </ScrollView>
...
const sampleText =
  'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum aliquet malesuada turpis quis ullamcorper.' +
